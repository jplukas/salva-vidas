...
ActiveRecord::Schema.define(version: 2019_06_25_193453) do
  ...
  create_table "figura_cursos", force: :cascade do |t|
    t.string "arquivo"
    t.binary "imagem"
    t.string "mimetype"
    t.integer "curso_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["curso_id"], name: "index_figura_cursos_on_curso_id"
  end

  create_table "figura_disciplinas", force: :cascade do |t|
    t.string "arquivo"
    t.binary "imagem"
    t.string "mimetype"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["disciplina_id"], name: "index_figura_disciplinas_on_disciplina_id"
  end
